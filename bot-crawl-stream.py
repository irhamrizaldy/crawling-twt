...
stream.filter(track=['coding', 'koding', 'ngoding', 'buat program', 'bikin program', 'joki program', 'buat flowchart', 'bikin flowchart', 'joki informatika', 'informatika', 'joki pemrograman', 'pemrograman dasar', 'joki java', 'bantu java', 'joki python', 'bantu python', 'joki c++', 'bantu c++', 'joki c#', 'bantu c#', 'buat web', 'buat website', 'bikin web', 'bikin website', 'joki php', 'bantu php', 'joki html', 'bantu html'])